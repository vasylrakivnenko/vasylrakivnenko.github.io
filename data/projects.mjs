/* ==========================================================================
   ...
   NOTHING GOES LIVE WITHOUT A DEFENSIBLE OUTCOME.

   `draft: true` holds an entry back — it stays here, fully written, but is
   not rendered. `node build.mjs` lists what is being held and why. When you
   have the number, replace the `outcome` and delete the `draft` line. That's
   the whole workflow: one edit per project, when the evidence exists.
   ========================================================================== */
...
export const projects = [
  ...
  },
  {
    ...
    draft: true, // no outcome figure yet — modelled annual value, or shortlist size vs candidates screened
  },
  {
    sector: "internal-ops",
    ...
    draft: true, // no outcome figure yet — questions/month or tickets deflected
  },
  {
    sector: "legal",
    ...
    draft: true, // no outcome figure yet — calls handled or change in response time
  },
  {
    sector: "internal-ops",
    ...
    draft: true, // no outcome figure yet — tickets deflected per month
  },
  {
    sector: "internal-ops",
    ...
    draft: true, // no outcome figure yet — applications/month, change in screening time
  },
  {
    sector: "internal-ops",
    ...
    draft: true, // no outcome figure yet — time-to-productivity or questions self-served
  },
  {
    sector: "legal",
    ...
    draft: true, // verified work, but no outcome line — is it deployed? screenings run?
  },
  {
    sector: "edutech",
    ...
    draft: true, // no outcome figure yet — students served or questions/term
  },
  {
    ...
    draft: true, // no outcome figure, and no detail from you — needs both
  },
  {
    sector: "healthtech",
    ...
    outcome: "Patent PL247981B1 granted, September 2025.",
  },
];
